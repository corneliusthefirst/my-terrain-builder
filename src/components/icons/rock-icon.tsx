  ...
  return (
    ...
    >
      ...
      >
        ...
        <stop offset=".46" stopColor="#8e8884"></stop>
      ...
      >
        ...
        <stop offset=".612" stopColor="#42565f" stopOpacity=".192"></stop>
        <stop offset=".757" stopColor="#455a64" stopOpacity="0"></stop>
      </linearGradient>
      <path
      ...
      >
        <stop offset="0" stopColor="#9e958e"></stop>
        <stop offset=".442" stopColor="#aea298"></stop>
      ...
      >
        <stop offset="0" stopColor="#9e958e"></stop>
        <stop offset=".25" stopColor="#aea298"></stop>
        <stop offset=".566" stopColor="#c9b8a9"></stop>
      </linearGradient>
      <path
      ...
      >
        <stop offset="0" stopColor="#37474f"></stop>
        <stop offset=".808" stopColor="#42565f" stopOpacity=".192"></stop>
        <stop offset="1" stopColor="#455a64" stopOpacity="0"></stop>
      </linearGradient>
      <path
